...
const API_KEY = "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";
const systemMessage = {
...
export const ChatGPT = (props) => {
  const [messages, setMessages] = useState([
    {
      message: "Hello, I am Brain Flow! Click the arrow for help",
      sentTime: "just now",
      sender: "BrainFlow"
    }
  ]);
  ...
  const handleHelpButtonClick = async () => {
    ...
    const newMessage = {
      message: `Help me with the current question,but dont provide the answer: ${currentQuestion}`,
      direction: 'outgoing',
      sender: "user"
    };
